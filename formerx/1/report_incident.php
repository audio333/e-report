...
$attachment = $_POST['attachment'];  
	 ...
	 if (isset($_POST['id'])) {
	 	...
	 	foreach ($idArr as $id) {
		 	...
		 	while (odbc_fetch_row($rs))
		 	{
		 	  ...
		 	  $mail->Body .='
				<table align="left" width="600" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; border: 1px solid #cccccc;">
				        <tr>
 ...
 $mail->Username = 'batangascluster@gmail.com';                 // SMTP username
 $mail->Password = 'Security123';                           // SMTP password
 $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
 $mail->CharSet = 'UTF-8';
 $mail->Port = 587;                                    // TCP port to connect to

 $mail->setFrom('batangascluster@gmail.com');
 ...
 // $mail->addAttachment('Koala.jpg');         // Add attachments
